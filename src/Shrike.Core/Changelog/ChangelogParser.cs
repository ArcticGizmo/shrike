...
namespace Shrike.Core.Changelog;
...
/// and hands it in. Headings look like <c>## [v0.2.0] - 2026-08-14</c>; the <c>v0.2.0</c> is the version.
/// </summary>
public static class ChangelogParser
{
    ...
    /// <summary>Pulls a <see cref="System.Version"/> out of a heading like <c>[v0.2.0] - 2026-08-14</c>.</summary>
